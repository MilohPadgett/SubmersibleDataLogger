...
2. Download the GUI:
3. <a id="raw-url" href="https://raw.githubusercontent.com/MilohPadgett/SubmersibleDataLogger/master/GUI.exe">Download FILE</a>
4. Run the GUI executable file
5. Click the ‘Select COM Port’ dropdown menu and choose the port that the STM32 is plugged into. If no ports appear, try pressing the ‘Refresh COM’ button and ensuring that the STM is properly connected. A light should be on in the top corner of the STM.
